...
const formValid = ({ formErrors,boolValid, ...rest }) => {
    let valid = true;
...
class App2 extends Component {
    ...
    handleSubmit(e) {
        ...
        const data = new FormData(form);
          ...
          for (let name of data.keys()) {
              console.log("name is "+ [name] + "data.keys is : " +data.keys());
    ...
    handleChange(e) {
        ...
        switch (name) {
            ...
            case "day":
                formErrors.day =
                    parseInt(value) == 0 ? "Required field!! Enter day" : "";
                break;
            case "month":
                formErrors.month =
                    parseInt(value) == 0 ? "Required field!! Enter month" : "";
                break;
            case "year":
                formErrors.year =
                    parseInt(value) == 0? "Required field!! Enter Year" : "";
                break;
            default:
                break;
        }
                    ...
                    <form onSubmit={this.handleSubmit} noValidate>
                        ...
                        <div className="birthday">
                            ...
                            <div>
                                ...
                                {formErrors.day == "" ? null : <span className="errorMessage">{formErrors.day}</span>}
                            ...
                            <div>
                                ...
                                {formErrors.month == "" ? null : <span className="errorMessage">{formErrors.month}</span>}
                            </div>
                            <div>
                                ...
                                {formErrors.year == "" ? null : <span className="errorMessage">{formErrors.year}</span>}
                        ...
                        <div className="dataSentToServer">
                            <span>Data to be sent to server {FormData}
